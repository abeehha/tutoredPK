...
import {
  academyConversationsRequest,
  academyEnrollmentsRequest,
  academySendMessageRequest,
  academyThreadRequest,
} from "../../api/academy";
...
export default function AcademyChatPage() {
  ...
  useEffect(() => {
    async function loadContacts() {
      ...
      try {
        ...
        const enrollmentContacts = (data?.enrollments || [])
        ...
        setContacts(enrollmentContacts);
      } catch (err) {
  ...
  return (
    <RoleLayout
      roleTitle="Academy"
      roleSubtitle="Reply to enrolled students and keep academic conversations organized."
